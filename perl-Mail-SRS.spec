...
Ten moduł jest implementacją biblioteki przepisującej adresy nadawcy
zgodnie ze schematem przepisywania SRS, aby pozwolić przekazującym
działać w świecie z SMTP z uwierzytelnieniem nadawcy.
...
Demon przepisujący adresy SRS, działający jako lokalny proces na
